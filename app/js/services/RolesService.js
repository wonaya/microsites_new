angular.module('RolesService',[]).service('RolesService',['$uibModal', '$rootScope', '$localStorage', '$location', '$state', '$timeout', '$q', '$translate', 'SystemsController', 'ProfilesController', 'MessageService', function($uibModal, $rootScope, $localStorage, $location, $state, $timeout, $q, $translate, SystemsController, ProfilesController, MessageService){
